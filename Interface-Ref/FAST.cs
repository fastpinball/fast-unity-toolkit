...
using EngineNodeAlias = Godot.Node3D;
using EngineKeyAlias  = Godot.Key;

// ----------- UNITY 3D ---------------
#elif UNITY_2020_3_OR_NEWER
using UnityEngine;

using EngineNodeAlias = UnityEngine.MonoBehaviour;
using EngineKeyAlias  = UnityEngine.KeyCode;
#endif
...
public partial class FAST: EngineNodeAlias
{
 ...
 bool HasStarted = false;
  ...
  /************************************************************************************************************/
  /************************************************************************************************************/
 #region Game_Engine_Interface
  // "Constructor"
 #if GODOT
  public override void _EnterTree(/*void*/)
  {
   // Instance already exists?
   if (CurrentFASTInstance != null)
 	{
 	 LogError("There is already a FAST Hardware instance!");
 	 QueueFree();
 	 return;
 	}
   // Store this instance
  ...
  // "Distructor"
 #if GODOT
  public override void _ExitTree(/*void*/)
 #elif UNITY_2020_3_OR_NEWER
  void OnDestroy(/*void*/)
 #endif 
  {
  ...
  {
   _UpdateInternal((float)delta);
  }
 #elif UNITY_2020_3_OR_NEWER
  void Update(/*void*/)
  {
   _UpdateInternal(Time.deltaTime);
  }
 #endif
#endregion
...
#region Engine_Utilities
 ...
 {
  if (CurrentFASTInstance != null)
	CurrentFASTInstance.StartupProcess(Callback, NodeOrder, ExpansionOrder);
 }
...
#region Switches
 ...
 public static bool IsSwitchDown(int SwitchIndex, EngineKeyAlias SpoofKey=EngineKeyAlias.None)
 {
  // Get the spoof key
#if GODOT
  return Input.IsPhysicalKeyPressed(SpoofKey);
#elif UNITY_2020_3_OR_NEWER
 ...
 /// <param name="SpoofKey">Optional. A unity keycode for "spoofing" a key press/trigger</param>
 /// <remarks>This switch does not invert switches- Meaning, optos will be in reverse of what you expect!</remarks>
 public static bool IsSwitchUp(int SwitchIndex, EngineKeyAlias SpoofKey=EngineKeyAlias.None)
 {
  // Get the spoof key
#if GODOT
  return (Input.IsPhysicalKeyPressed(SpoofKey) == false);
#elif UNITY_2020_3_OR_NEWER
 ...
 /// <param name="SpoofKey">Optional. A unity keycode for "spoofing" a key press/trigger</param>
 /// <remarks>This switch does not invert switches- Meaning, optos will be in reverse of what you expect!</remarks>
 public static bool IsSwitchDownTriggered(int SwitchIndex, EngineKeyAlias SpoofKey=EngineKeyAlias.None)
 {
  // Get the spoof key
#if GODOT
  return false;
 ...
 /// <param name="SpoofKey">Optional. A unity keycode for "spoofing" a key press/trigger</param>
 /// <remarks>This switch does not invert switches- Meaning, optos will be in reverse of what you expect!</remarks>
 public static bool IsSwitchUpTriggered(int SwitchIndex, EngineKeyAlias SpoofKey=EngineKeyAlias.None)
 {
  // Get the spoof key
#if GODOT
  return false;
 ...
 /// <param name="SpoofKey">Optional. A unity keycode for "spoofing" a key press/trigger</param>
 /// <remarks>This switch does not invert switches- Meaning, optos will be in reverse of what you expect!</remarks>
 public static bool IsSwitchTriggered(int SwitchIndex, EngineKeyAlias SpoofKey=EngineKeyAlias.None)
 {
  // Get the spoof key
#if GODOT
  return false;
...
#region InternalFunctions
 ...
 /************************************************************************************************************/
 /************************************************************************************************************/
 async Task StartupProcess(BasicResultCallback Callback, List<eNodeBoards> NodeOrder, List<eExpansionBoards> ExpansionOrder)
 {
 ...
 /************************************************************************************************************/
 /************************************************************************************************************/
 void _UpdateInternal(float ElapsedSeconds)
 {
 }
 ...
 /************************************************************************************************************/
  ...
  /************************************************************************************************************/
  /************************************************************************************************************/
  public static void GeneralLog(string LogData)      
  {
 #if GODOT
   GD.Print(LogData);
 #elif UNITY_2020_3_OR_NEWER
  ...
  {
 #if GODOT
   GD.Print("FastProtocol Info> " + LogData);
 #elif UNITY_2020_3_OR_NEWER
 ...
 protected static void LogWarning(string LogData) 
  {
 #if GODOT
   GD.PushWarning("FastProtocol> " + LogData);
 #elif UNITY_2020_3_OR_NEWER
 #if UNITY_EDITOR  
  ...
  {
 #if GODOT
   GD.PushError("FastProtocol> " + LogData);
 #elif UNITY_2020_3_OR_NEWER
 #if UNITY_EDITOR  
